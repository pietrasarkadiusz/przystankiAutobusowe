...
namespace PolaczeniaAutobusowe.Areas.Identity.Pages.Account.Manage
{
    public class ResetAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Nie można załadować użytkownika z I '{_userManager.GetUserId(User)}'.");
            }
            ...
            StatusMessage = "Klucz aplikacji uwierzytelniającej został zresetowany. Konieczne będzie skonfigurowanie aplikacji uwierzytelniającej za pomocą nowego klucza.";
